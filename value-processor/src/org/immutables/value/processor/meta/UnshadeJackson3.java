...
public final class UnshadeJackson3 {
  ...
  private static final String JACKSON3_PREFIX =
      System.getProperty("jackson3.prefix", "tools.jackson");
  ...
  public static String prefix() {
    return MoreObjects.firstNonNull(prefixOverride, JACKSON3_PREFIX);
  }
}
