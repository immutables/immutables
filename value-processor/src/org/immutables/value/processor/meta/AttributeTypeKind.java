...
public enum AttributeTypeKind {
  ...
  LIST("List",
      ...
      UnshadeGuava.qualify("collect.ImmutableList")),
  SET("Set",
      java.util.Set.class.getName(),
      UnshadeGuava.qualify("collect.ImmutableSet")),
  ENUM_SET("Set"),
  SORTED_SET(
      "SortedSet",
      java.util.SortedSet.class.getName(),
      java.util.NavigableSet.class.getName(),
      UnshadeGuava.qualify("collect.ImmutableSortedSet")),
  MAP("Map",
      java.util.Map.class.getName(),
      UnshadeGuava.qualify("collect.ImmutableMap")),
  ENUM_MAP("Map"),
  SORTED_MAP(
      "SortedMap",
      java.util.SortedMap.class.getName(),
      java.util.NavigableMap.class.getName(),
      UnshadeGuava.qualify("collect.ImmutableSortedMap")),
  MULTISET(
      "Multiset",
      UnshadeGuava.qualify("collect.Multiset"),
      UnshadeGuava.qualify("collect.ImmutableMultiset")),
  SORTED_MULTISET(
      "SortedMultiset",
      UnshadeGuava.qualify("collect.SortedMultiset"),
      UnshadeGuava.qualify("collect.ImmutableSortedMultiset")),
  MULTIMAP(
      "Multimap",
      UnshadeGuava.qualify("collect.Multimap"),
      UnshadeGuava.qualify("collect.ImmutableMultimap")),
  LIST_MULTIMAP(
      "ListMultimap",
      UnshadeGuava.qualify("collect.ListMultimap"),
      UnshadeGuava.qualify("collect.ImmutableListMultimap")),
  SET_MULTIMAP(
      "SetMultimap",
      UnshadeGuava.qualify("collect.SetMultimap"),
      UnshadeGuava.qualify("collect.ImmutableSetMultimap")),
  BI_MAP("BiMap",
      UnshadeGuava.qualify("collect.BiMap"),
      UnshadeGuava.qualify("collect.ImmutableBiMap")),
  OPTIONAL_JDK(
      "Optional",
      "java.util.Optional"),
  OPTIONAL_INT_JDK(
  ...
  OPTIONAL_GUAVA(
      "Optional",
      UnshadeGuava.qualify("base.Optional")),
  OPTION_FUGUE(
      "Option",
