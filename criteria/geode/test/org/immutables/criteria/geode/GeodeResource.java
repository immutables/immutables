...
public class GeodeResource extends ExternalResource {
  ...
  private GeodeResource(final ServerLauncher launcher) {
  ...
  static GeodeResource create() {
    ...
    return new GeodeResource(launcher);
  }
   ...
   */
  private static class RefCountPolicy extends GeodeResource {

    private final AtomicInteger refCount;

    private final GeodeResource policy;

    RefCountPolicy(final GeodeResource policy) {
